								...
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li class="hassubs">
										...
										<ul>
											...
											<li><a href="blogg.php">Blog<i class="fas fa-chevron-down"></i></a></li>
					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<ul class="page_menu_nav">
								...
								<li class="page_menu_item"><a href="blogg.php">blog<i class="fa fa-angle-down"></i></a></li>
				...
				<div class="col">
					<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
						...
						<div class="newsletter_content clearfix">
							<form method="POST" action="../views/ajoutsubscriber.php" class="newsletter_form">
								<input type="email" name="email" id ="email" class="newsletter_input" required="required" placeholder="Enter your email address">
								<button class="newsletter_button" type="submit" id="ajouter" value="ajouter">Subscribe</button>
							</form>
